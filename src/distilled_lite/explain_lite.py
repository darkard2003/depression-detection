...
def main():
    print("=" * 60)
    print("Running SHAP Explainability for Distilled Lite")
    print("=" * 60)
    ...
    try:
        ...
        shap.summary_plot(sv, features=X_explain, feature_names=selected_feature_names, plot_type='bar', max_display=20, show=False)
        plt.title('Distilled Lite: SHAP Feature Importance (Top 20)')
        plt.tight_layout()
        shap_path = os.path.join(OUTPUT_DIR, "xai_shap_lite.png")
