...
OUTPUT_DATA_DIR = "data_processed/processed_lite"
OUTPUT_MODEL_DIR = "outputs/distilled_lite/reddit_mlp_distilled_lite"
K_FEATURES = 2000
...
def main():
    print("=" * 60)
    print("Generating Lite Model Features From Scratch")
    print("=" * 60)
    ...
    # 1. Multi-threaded Lexical / Sentiment Extraction
    ...
    # Create DataFrame of non-TFIDF features
    extra_features_df = pd.DataFrame(features_list)
    print(f"Extracted features dataframe shape: {extra_features_df.shape}")
    ...
    # 3. Fit MinMaxScaler on engineered features
    ...
    # 7. Save output features and targets
    print("Saving processed features and targets...")
    np.save(os.path.join(OUTPUT_DATA_DIR, "X_lite.npy"), X_selected)
    ...
    print("=" * 60)
    print("🎉 Lite features generated successfully!")
    print("=" * 60)
