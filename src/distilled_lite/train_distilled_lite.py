...
DATA_DIR = "data_processed/processed_lite"
OUTPUT_DIR = "outputs/distilled_lite"
PROJECT_NAME = "reddit_mlp_distilled_lite"
ALPHA = 0.1
SEED = 42
...
def build_model(hp):
    ...
    # Prune model layers and size for "lite" resource consumption (max 2 shallow layers)
...
def main():
    ...
    print("Loading pre-computed lite features and targets...")
    X = np.load(os.path.join(DATA_DIR, "X_lite.npy"))
    ...
    tuner = kt.Hyperband(
        ...
        max_epochs=20,
        factor=3,
        directory='outputs/distilled_lite/tuning',
