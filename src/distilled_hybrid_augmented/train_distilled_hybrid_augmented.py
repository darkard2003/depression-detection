...
DATA_DIR = "data_processed/processed_hybrid_augmented"
OUTPUT_DIR = "outputs/distilled_hybrid_augmented"
PROJECT_NAME = "reddit_mlp_distilled_hybrid_augmented"
ALPHA = 0.1
SEED = 42
...
def main():
    ...
    print("Loading pre-computed augmented hybrid features and targets...")
    ...
    tuner = kt.Hyperband(
        ...
        max_epochs=20,
        factor=3,
        directory='outputs/distilled_hybrid_augmented/tuning',
