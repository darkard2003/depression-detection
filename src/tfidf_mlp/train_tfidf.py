...
os.makedirs('outputs/tfidf_mlp', exist_ok=True)
...
os.makedirs(path.join('outputs/tfidf_mlp', PROJECT_NAME), exist_ok=True)
model_path = path.join('outputs/tfidf_mlp', PROJECT_NAME, f'{PROJECT_NAME}.keras')
...
metadata_path = path.join('outputs/tfidf_mlp', PROJECT_NAME, f'{PROJECT_NAME}_metadata.json')
